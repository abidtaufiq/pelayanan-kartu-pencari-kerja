                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?=base_url();?>Pencaker/aktif_data"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" id="pesan" rows="3"
                                                                        name="pesan">Kepada yang terhormat Bpk/Ibu <?=$nama_lengkap?>, Kartu Pencari Kerja AK1 anda telah aktif !</textarea>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" class="form-control"
                                                                        id="mulai_berlaku" name="mulai_berlaku"
                                                                        value="<?=$mulai_berlaku?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="akhir_berlaku">Akhir Berlaku</label>
                                                                    <input type="date" class="form-control"
                                                                        id="akhir_berlaku" name="akhir_berlaku"
                                                                        value="<?=$akhir_berlaku?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="pesan">Pesan</label>
                                                                    <textarea class="form-control" id="pesan" rows="3"
                                                                        name="pesan" required>Kepada yang terhormat Bpk/Ibu <?=$nama_lengkap?>, Kartu Pencari Kerja AK1 anda membutuhkan perpanjangan !, berlaku mulai <?=$mulai_berlaku?> dan berakhir pada <?=$akhir_berlaku?>, Trimakasih</textarea>
                                                                </div>
                                                                <button type="submit"
                                                                    class="btn btn-primary">Submit</button>
                                                            </form>
                                        ...
                                        echo '';
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="foto_surat_pengalaman_kerja">Foto Surat
                                                                        Pengalaman Kerja</label>
                                                                    <input type="file" class="form-control"
                                                                        id="foto_surat_pengalaman_kerja"
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="foto_transkrip_nilai">Foto Transkrip
                                                                        Nilai</label>
                                                                    <input type="file" class="form-control"
                                                                        id="foto_transkrip_nilai"
